...
def exporttiles (X, x, y, a, b, frame, filename):
    ...
    im.save(filename)  # seems to ignore the colormap
...
for iter in range (10000):
    ...
    exporttiles (w_mot, 1, size_mot, size_a, size_b, 1, path.abspath("C:\Users\William\Desktop\STUFF\Capstone\reinforcementlearning\tmp\coco\obs_v_0_0.pgm"))
